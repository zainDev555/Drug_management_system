  ...
  <div class="container pt-4">
    ...
    <section>
      ...
      <div class="col-xl-12 col-sm-10 col-12 mb-4">
        <div class="col-xl-12 col-sm-10 col-12 mb-4">
          <p class="badge bg-info">Use filter for  find specific record</p>
  ...
  $result_per_page = 5;
        ...
        if ($result->num_rows > 0) {
           ...
           if(isset($_POST['btnseach'])){       
               ...
               $sql = "SELECT * from sales_medicine a, sales_manager b  where city='$city' AND created_at between   '$date_1'  AND   '$date_2'   LIMIT " . $this_page_f_result . ',' . $result_per_page;
           }else{
