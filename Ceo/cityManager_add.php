              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form action="./function.php" method="post">
                    ...
                    <div class="form-group">
                      <button class="btn btn-info" type="submit" name="save_city_manager"> save</button>
                            ...
                            ?>
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $row['email']; ?></td>
                                   ...
                                   <a  class="btn btn-sm     btn-info text-white" href="./editcityManager.php?id=<?php echo $row['id'] ?>" ><span class="fa fa-pen " ></span></a>
                                   <form action="./function.php" method="post">
                                       <input type="hidden" name="id" value="<?php echo $row['id']?>" >
                                       <button type="submit" class="btn btn-sm btn-danger" name="delcitymanagernow"><span class="fa fa-trash "></span> </button>
                                   </form>
                                    </td>
                                </tr>
                    <?php
