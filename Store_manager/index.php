    ...
    <section>
      ...
      <div class="col-xl-6 col-sm-6 col-12 mb-4">
          <div class="card">
            ...
            <span class='fa fa-medkit '> </span> <h5 class="card-title">Our branach salesman</h5>
              <p class="card-text">
                  <?php
                  $sql="SELECT count(*) as total from sales_manager where branch_name='$_SESSION[branch_name]'";
