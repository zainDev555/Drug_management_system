      ...
      <div class="row">
        <div class="col-xl-12 col-sm-10 col-12 mb-4">
            <div class="card">
                ...
                <h4>update country Manager</h4>
                 
  <?php 
       $sql = "SELECT * FROM country_manager where id='$_GET[id]'";
       ...
       if ($result->num_rows > 0) {
           ...
           ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <button class="btn btn-info" type="submit" name="updatecountry_manager"> save</button>
