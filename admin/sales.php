  ...
  <div class="container pt-4">
    ...
    <section>
      <div class="row">
        ...
        <span  class='badge badge-primary bg-info' >In this session you will be find sales  between start date to last date  </span>          <table class="table">
            <thead>
              <tr>
            ...
            <?php
              if(isset($_POST['btnseach'])){       
                ...
                $sql = "SELECT * FROM sales_medicine   where created_at between   '$date_1'  AND   '$date_2'";
            }else{
