                ...
                <div class="modal-body">
                  ...
                  <form action="./function.php" method="post">
                    ...
                    <div class="form-group">
                      <label for="medicine">Ceo Name </label>
                      <input type="text" class="form-control" required name="name" id="name">

                    </div>
                  
                    <div class="form-group">
                      <label for="medicine">Ceo email</label>
                      <input type="text" class="form-control" required name="email" id="email">

                    </div>
                    <div class="form-group">
                      <label for="medicine">Ceo Cnic</label>
                    ...
                    <div class="form-group">
                      <button class="btn btn-info" type="submit" name="save_ceo"> save</button>
                            ...
                            ?>
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $row['email']; ?></td>
                                   ...
                                   <a  class="btn btn-sm     btn-info text-white" href="./editceo.php?id=<?php echo $row['id'] ?>" ><span class="fa fa-pen " ></span></a>
                                   <form action="./function.php" method="post">
                                       <input type="hidden" name="id" value="<?php echo $row['id']?>" >
                                       <button type="submit" class="btn btn-sm btn-danger" name="delceo"><span class="fa fa-trash "></span> </button>
                                   </form>
                                    </td>
                                </tr>
                    <?php
